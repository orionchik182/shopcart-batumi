...
// Query: *[_type == 'blog' && isLatest == true] | order(publishedAt asc){    ...,    blogcategories[]->{    title}}
...
// Query: *[  _type == "blog"  && defined(slug.current)  && slug.current != $slug]|order(publishedAt desc)[0...$quantity]{...  publishedAt,  title,  mainImage,  slug,  author->{    name,    image,  },  "blogcategories": blogcategories[]->{ title, "slug": slug.current }}
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    " *[_type == 'blog' && isLatest == true] | order(publishedAt asc){\n    ...,\n    blogcategories[]->{\n    title}}": LATEST_BLOG_QUERYResult;
